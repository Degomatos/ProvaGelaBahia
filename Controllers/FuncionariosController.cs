...
namespace ProvaGelaBahia.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public FuncionariosController(ProvaGelaBahiaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdFuncionario,Nome_Funcionario,Cpf_Funcionario,Salario,Comissao,status,Servicos_IdServicos")] Funcionario funcionario)
        {
